            ...
            if apiname == api_get_result:
                if result['data'] != '[]':
                    for value in range(0,3):
                        try:
                            user_text = json.loads(result['data'])[value]['onebest']
...
def get_usertext():
    api = RequestApi(appid="5f5c8f88", secret_key="57e231ddf4522c70594437d5da25e413",
                     upload_file_path="./audiofile/usersay.wav")
    api.all_api_request()
    print(user_text)
    return user_text
